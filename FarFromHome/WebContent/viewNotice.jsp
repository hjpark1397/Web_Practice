  ...
  <tr>
   ...
   <form name = writeform method = post action = "postAction.jsp" enctype="multipart/form-data" align = "center">   
     ...
     <tr>
      ...
      <td>&nbsp;<%= notice.getNoticeDate().substring(0, 11) + notice.getNoticeDate().substring(11, 13) + "시"
...
<!--      <tr>
     ...
     <tr align="center">
      ...
      <td colspan="2">
       ...
       %>
       			<a href = "modify.jsp?noticeID<%= noticeID %>">수 정</a>
       			<a onclick = "return confirm('정말로 삭제하시겠습니까?')" href = "deletenotice.jsp?noticeID<%= noticeID %>">삭 제</a>    
